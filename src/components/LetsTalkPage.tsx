      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-6 rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 shadow-2xl shadow-black/20">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="rounded-[1.5rem] border border-white/10 bg-[#080808] p-6 text-sm text-zinc-300">
            ...
            <p className="mt-3 leading-7">Email: hello@rsn01.dev</p>
            <p className="mt-2 leading-7">Location: Nepal / Remote</p>
            <a href="mailto:hello@rsn01.dev" className="mt-6 inline-flex rounded-full border border-purple-500/30 px-4 py-2 text-purple-300 transition hover:bg-purple-500/10">

      ...
      <div className="relative z-20 w-full max-w-5xl mx-auto flex flex-col items-center">
        ...
        <div className="w-full mt-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <QuickCard 
            ...
            label="Availability" 
            value="Available for Freelancing" 
            delay={0.9} 
          />
        </div>
      </div>
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-white/5 bg-white/[0.01]">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-display font-medium text-xs tracking-wider text-zinc-400">ROSHAN SAH &mdash; OFFICIAL PORTFOLIO</span>
                </div>
                <button
                  onClick={() => setIsResumeOpen(false)}
              ...
              <div className="p-6 sm:p-10 overflow-y-auto space-y-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 border-b border-white/5 pb-8">
                  <div>
                    <h2 className="font-display font-bold text-3xl text-white">Roshan Sah</h2>
                    <p className="text-purple-400 font-mono text-xs tracking-wide mt-1 font-semibold uppercase">IT Officer | Full Stack Developer | Digital Creator</p>
                    <p className="text-zinc-500 text-xs mt-2 flex items-center gap-1"><MapPin className="w-3.5 h-3.5 text-purple-400" /> Simara, Bara, Nepal</p>
                  </div>
                  <div className="space-y-1.5 text-xs text-zinc-400 font-mono bg-white/[0.02] p-4 rounded-xl border border-white/5">
                    ...
                    <p className="flex items-center gap-2"><Globe className="w-3.5 h-3.5 text-purple-400" /> rsn01.portfolio</p>
                  </div>
                </div>
                  ...
                  <div className="space-y-4 font-sans">
                    <div className="p-4 rounded-xl bg-white/[0.01] border border-white/5">
                      <div className="flex justify-between items-start gap-4">
                        <h4 className="font-medium text-white text-sm">IT Officer</h4>
                        <span className="text-[10px] font-mono text-purple-400 px-2 py-0.5 rounded bg-purple-500/10 border border-purple-500/20">Little Flower Secondary School, Parwanipur</span>
                      </div>
                      <p className="text-zinc-400 text-xs mt-2 leading-relaxed">
                        Managing IT infrastructure, network administration, digital system implementation, software installation & troubleshooting, and technology integration in education.
                      </p>
                    </div>

                    <div className="p-4 rounded-xl bg-white/[0.01] border border-white/5">
                      <div className="flex justify-between items-start gap-4">
                        <h4 className="font-medium text-white text-sm">Full Stack Developer & Freelancer</h4>
                        <span className="text-[10px] font-mono text-zinc-500 px-2 py-0.5 rounded bg-white/5 border border-white/10">Active Solutions</span>
                      </div>
                      <p className="text-zinc-400 text-xs mt-2 leading-relaxed">
                        Building modern websites, web applications, and digital solutions for businesses, startups, educational institutions, and individuals.
                      </p>
                    </div>
                  </div>
                </div>

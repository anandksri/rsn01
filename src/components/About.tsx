          ...
          <div className="lg:col-span-5 flex justify-center">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <h3 className="mt-6 font-display font-black tracking-tighter text-white uppercase text-lg">Roshan <span className="text-[#7C3AED]">Sah</span></h3>
                <p className="text-[10px] text-purple-300 font-mono tracking-widest mt-1">SIMARA, NEPAL</p>

...
import { Mail, MapPin, Facebook, Twitter, Send, CheckCircle2, Copy, Check } from 'lucide-react';
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          {/* Column 1: Info Deck & Social Matrix */}
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8 }}
                className="glow-card glass p-5 rounded-2xl border border-white/5 flex items-center justify-between gap-4 group clickable"
              >
                <div className="flex items-center gap-4">
                  <div className="p-2.5 rounded-xl bg-white/[0.02] border border-white/5 text-purple-400 group-hover:bg-purple-500/10 group-hover:border-purple-500/20 transition-all duration-300">
                    <Mail className="w-5 h-5" />
                  </div>
                  <div>
                    <span className="block text-[9px] font-mono tracking-widest text-zinc-500 uppercase">EMAIL DIRECTLY</span>
                    <span className="block text-white font-medium text-sm sm:text-base mt-0.5 select-all">iamrsn01@gmail.com</span>
                  </div>
                </div>
                <button
                  onClick={handleCopyEmail}
                  className="p-2 rounded-lg bg-white/[0.03] border border-white/5 hover:bg-white/10 text-zinc-400 hover:text-white transition-all"
                  title="Copy email address"
                >
                  {copiedEmail ? <Check className="w-4 h-4 text-purple-400" /> : <Copy className="w-4 h-4" />}
                </button>
              </motion.div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8, delay: 0.1 }}
                className="glow-card glass p-5 rounded-2xl border border-white/5 flex items-center gap-4 group"
              >
                ...
                <div>
                  ...
                  <span className="block text-white font-medium text-sm sm:text-base mt-0.5">Simara, Bara, Nepal</span>
                </div>
              </motion.div>
            ...
            <div className="space-y-4 pt-4">
              <span className="block font-mono text-[9px] tracking-widest text-zinc-500 uppercase">SOCIAL CHANNELS</span>
              <div className="grid grid-cols-2 gap-4">
                
                {/* Facebook Card */}
                <motion.a
                  href="https://facebook.com/rsn01"
                  target="_blank"
                  rel="noreferrer"
                  ...
                  className="glow-card glass p-4 rounded-xl border border-white/5 flex items-center justify-between group clickable hover:border-purple-500/15"
                >
                  ...
                  <span className="text-[9px] font-mono text-zinc-600 group-hover:text-purple-400">/rsn01</span>
                </motion.a>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-semibold text-zinc-300 group-hover:text-white transition-colors">X (Twitter)</span>
                  </div>
                  <span className="text-[9px] font-mono text-zinc-600 group-hover:text-purple-400">@Rosan4eva</span>
                </motion.a>
